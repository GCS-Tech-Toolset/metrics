...
public class AppMetrics
{
    ...
    public AtomicLong createGauge(@NonNull String name_, String... tags_)
    {
        ...
        AtomicLong val = new AtomicLong(0);
        final Tags tags = combineTags(getCommonTags(), tags_);
        _registry.gauge(name_, tags, val);
        return val;
    }
    ...
    private Tags combineTags(Tags commonTags_, String[] tags_)
    {
        return Tags.concat(commonTags_, tags_);
    }
    ...
    public Counter createCounter(@NonNull String name_, String... tags_)
    {
        ...
        Tags tags = combineTags(getCommonTags(), tags_);
        return _registry.counter(name_, tags);
    }
